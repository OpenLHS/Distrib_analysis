...
#-------------------------------------------------------------------------------
# Response vector
y <- read.csv("Outputs/Coord/y.csv")[,1] # (checked, all equal)
...
K_all <- as.matrix(read.csv("Outputs/Coord/K_all.csv")) # (checked, all equal)

# Optimal parameter alpha_hat (checked)
alpha_hat <- as.matrix(read.csv("Outputs/Coord/alpha_hat.csv")) # (checked, all equal)

# Blocks of XVX
Block_Client1 <- as.matrix(read.csv("Outputs/Coord/Block_Client1.csv")) # (checked, all equal)
...
#==============================================================================================================================================================
# End of "Recovering the original data at the CC"
#==============================================================================================================================================================
