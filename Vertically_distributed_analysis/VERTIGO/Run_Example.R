...
if(SaveNodes){
  # Node 1
  write.csv(alpha_hat, file = "Outputs/Node1/alpha_hat.csv")
  
  # Node 2
  write.csv(alpha_hat, file = "Outputs/Node2/alpha_hat.csv")
  
  # Node 3
  write.csv(alpha_hat, file = "Outputs/Node3/alpha_hat.csv")
  
}

if(SaveCC){
  # CC
  write.csv(alpha_hat, file = "Outputs/Coord/alpha_hat.csv")
}
...
#-------------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  exp_client3 <- exp(beta_0)*exp(X3_scaled%*%t(beta_node_3))
