...
The files in this folder can be used to execute a vertically distributed linear regression analysis. Assuming a data structure similar to the data nodes `.csv` files in the example folder, this code can be used to execute a response-node operation or a covariate-node operation for a vertically distributed linear regression model.
