# Vertically distributed nonpenalized linear regression (VALINRIS)

## Before using

- Make sure to adjust the number of files `Data_node_call_lin-regV_k.R` according to the number of nodes, and make sure to change the value of `manualk` to the node number.
...
This folder contains generic code and examples of a vertically distributed nonpenalized linear regression model.
