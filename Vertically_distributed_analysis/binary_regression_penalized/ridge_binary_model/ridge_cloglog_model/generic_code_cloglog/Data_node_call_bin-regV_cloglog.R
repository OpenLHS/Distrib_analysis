...
if (nbprimerfilesA == 1) {
  source("Data_node_call_iter_bin-regV.R")
  data_call_iter_bin_reg(manualwd,manualk,path)
} else if(nbprimerfilesA == 0) {
  source("Data_node_call_init_bin-regV.R")
  data_call_init_bin_reg(manualwd,manualk,path)} else {
