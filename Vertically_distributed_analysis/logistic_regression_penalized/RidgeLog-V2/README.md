# Vertically distributed penalized logistic regression (RidgeLog-V2)
...
This folder contains generic code and examples of a vertically distributed ridge logistic regression model (RidgeLog-V2). 
In comparison with the previously proposed method RidgeLog-V, RidgeLog-V2 does not require to share the response vector outside the response-node and allows the response-node to conduct cross-validation for the choice of the penalty parameter.
