...
vert_logistic_regression_example_coordnode_handler <- function(man_wd=-1, man_lambda=-1, expath="", man_seed=1){
  ...
  if (nb_node1_files==1 & nb_node_output_files>0) {
    ...
    coord_log_reg(man_wd = manualwd, man_lambda = lambda, expath = examplefilepath, privacy_switch = privacy, man_seed = manualseed)
  } else {
