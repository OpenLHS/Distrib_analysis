...
for(replicate in 1:nb_iter){
  ...
  cox_regression_example_datanode_handler(nodeid = 1, expath = examplefilepath)
  cox_regression_example_datanode_handler(nodeid = 2, expath = examplefilepath)
  cox_regression_example_datanode_handler(nodeid = 3, expath = examplefilepath)
  
  # Run coordination node code
  setwd(this.dir())
  source("../../example_handler/Coord_node_call_iter_log-reg_ex.R")
  cox_regression_example_coordnode_handler(expath = examplefilepath)
