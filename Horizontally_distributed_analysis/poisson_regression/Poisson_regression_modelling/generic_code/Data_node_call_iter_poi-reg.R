...
data_call_iter_poi_reg <- function(man_wd=-1,man_nodeid=-1, man_iter=-1, expath="") {
...
if (k >= 0 & t >= 0) {
  source("Data_node_core_iter_poi-reg.R")
  data_iter_poi_reg(manualwd,k,t,examplefilepath)
} else {
