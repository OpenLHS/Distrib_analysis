...
if (nbprimerfiles > 0) {
  source("Data_node_call_iter_poi-reg.R")
  data_call_iter_poi_reg(manualwd,manualk,manualt,path)
} else {
  source("Data_node_call_init_poi_reg.R")
  data_call_init_poi_reg(manualwd,manualk,path)
  }
