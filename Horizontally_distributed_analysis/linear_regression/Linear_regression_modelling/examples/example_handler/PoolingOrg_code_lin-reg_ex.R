...
linear_regression_example_pooled_handler <- function(expath="", nnodes = -1){
  ...
  write.csv(output, file=paste0(examplefilepath, "PoolingOrg_results_centralised_lin_reg.csv"))
